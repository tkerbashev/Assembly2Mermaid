...
namespace MermaidExtractionEngine
{
    ...
    internal class Types
    {
        ...
        private static List<string> GetReferencedTypesNames( Type type )
        {
        ...
        private static void GetFieldsReferences( Type type, ref List<string> typeReferences )
        {
            ...
            foreach (var field in fields)
            {
                ...
                if (!IsSystemType( field.FieldType ))
                {
                    ...
                    if (!field.FieldType.Assembly.ManifestModule.Name.StartsWith( "System." ) &&
                ...
                foreach (var referencedType in referencedTypes)
                {
                    ...
                    if (!referencedTypeAssemblyName.StartsWith( "System." ) && referencedType.FullName != null &&
        ...
        private static void GetMethodsReferences( Type type, ref List<string> typeReferences )
        {
            ...
            foreach (var method in methods)
            {
                ...
                if (!IsSystemType( method.ReturnParameter.ParameterType ))
                {
                    ...
                    if (!returnTypeAssemblyName.StartsWith( "System." ) && returnTypeName != null &&
                ...
                foreach (var parameter in methodParameters)
                {
                    ...
                    if (!parameterTypeAssemblyName.StartsWith( "System." ) && parameterTypeName != null &&
        ...
        private static void GetNestedTypesReferences( Type type, ref List<string> typeReferences )
        {
            ...
            foreach (var nestedType in nestedTypes)
            {
                ...
                if (!nestedTypeAssemblyName.StartsWith( "System." ) && pureNestedType?.Name != null &&
